# 전성빈 | Automotive Embedded Software

**차량의 데이터를 수집하고, 동작을 구현하며, 요구사항으로 검증합니다.**

자작차 동아리의 차량 데이터 로거 개발을 시작으로 임베디드 소프트웨어와 차량 시스템을 공부하고 있습니다. CAN 통신과 센서 데이터 수집부터 ECU 테스트 자동화, 협력주행과 차량 제어까지 구현하며 배운 내용을 기록합니다.
